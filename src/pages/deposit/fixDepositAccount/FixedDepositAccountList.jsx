  ...
  const approveAction = [
    {
      ...
      data: (data) => {
        navigate("/fix-deposit-account/view", {
          state: {
            endpoint: `saving-accounts/particular/fixAccounts/${data?.id}`,
          },
        });
      },
    },
    ...
    <div className="flex flex-col mx-4 text-black dark:text-white">
      <div className="mt-3 flex w-full space-y-2 flex-col md:flex-row md:items-center md:justify-between">
        ...
        <div className="flex flex-col">
          <button
            type="button"
            onClick={() => navigate("/fix-deposit-account/create")}
...
export default FixedDepositAccountList;
